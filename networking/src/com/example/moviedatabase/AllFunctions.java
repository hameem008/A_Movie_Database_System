...
public class AllFunctions {
    public Movie searchByMovieTitle(List<Movie> the_list,String movie_name){
    ...
    public List<Movie> searchByProductionCompany(List<Movie>the_list,String ProductionCompany){
        Boolean result=false;
        List<Movie> a_list=new ArrayList<>();
        for(Movie m:the_list){
    ...
    public Set<String> listOfProductionCompany(List<Movie>the_list){
        Set<String> ProductionCompany=new HashSet<>();
        for(Movie m:the_list){
            ProductionCompany.add(m.getProductionCompany());
        }
